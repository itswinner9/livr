  ...
  return (
    <main className="h-screen flex overflow-hidden">
      <CanadianSkyscrapers
        ...
        description="Help others find their perfect home by sharing honest reviews about neighborhoods and buildings you know."
      >
        <div></div>
      </CanadianSkyscrapers>

      {/* Right Panel - Signup Form */}
      <div className="w-full lg:w-3/5 flex flex-col px-4 sm:px-6 lg:px-8 xl:px-12 py-4 lg:py-8 overflow-y-auto">
        <div className="max-w-md mx-auto w-full my-auto py-8">
          ...
          <div className="mb-6 lg:mb-8">
            ...
            <p className="text-sm lg:text-base text-gray-600">Join our community and start sharing reviews</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 lg:py-3 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none transition-all text-sm lg:text-base"
